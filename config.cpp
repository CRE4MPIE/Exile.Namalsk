...
class CfgExileCustomCode 
{
	...
	*/
	...
	ExileClient_object_player_bambiStateBegin = "addons\custom\ExileClient_object_player_bambiStateBegin.sqf";
	ExileServer_object_player_event_onMpKilled = "addons\custom\ExileServer_object_player_event_onMpKilled.sqf";
	ExileServer_object_player_network_createPlayerRequest = "addons\custom\ExileServer_object_player_network_createPlayerRequest.sqf";
	ExileClient_system_lootManager_thread_spawn = "addons\custom\ExileClient_system_lootManager_thread_spawn.sqf";
	ExileClient_object_item_construct = "addons\custom\ExileClient_object_item_construct.sqf";
	
	// Extra Logging for Infistar
	ExileServer_system_territory_network_payTerritoryProtectionMoneyRequest = "addons\custom\ExileServer_system_territory_network_payTerritoryProtectionMoneyRequest.sqf";
	ExileServer_system_trading_network_purchaseItemRequest = "addons\custom\ExileServer_system_trading_network_purchaseItemRequest.sqf";
	ExileServer_system_trading_network_purchaseVehicleRequest = "addons\custom\ExileServer_system_trading_network_purchaseVehicleRequest.sqf";
	ExileServer_system_trading_network_wasteDumpRequest = "addons\custom\ExileServer_system_trading_network_wasteDumpRequest.sqf";
	ExileServer_system_trading_network_sellItemRequest = "addons\custom\ExileServer_system_trading_network_sellItemRequest.sqf";
	ExileServer_system_trading_network_sendMoneyRequest = "addons\custom\ExileServer_system_trading_network_sendMoneyRequest.sqf";
...
class CfgExileLootSettings
{
	 ...
	 */
	minimumDistanceToTraderZones = 0;
